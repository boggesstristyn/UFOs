...
function buildTable(data) {
    ...
    // THEN, loop through each object in the data and append a row and cells for each value in the row
...
function handleClick() {
    ...
    // atttach an event to listen for the form button
    d3.selectAll("#filter-btn").on("click", handleClick);

    // build the able when the page loads
